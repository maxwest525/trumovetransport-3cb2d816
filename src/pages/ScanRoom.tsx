        ...
        <section className="px-3 sm:px-6 lg:px-8 pb-8 sm:pb-10">
          <div className="max-w-7xl mx-auto">
            ...
            <div
              ...
              className={`grid grid-cols-1 gap-4 lg:gap-4 lg:grid-cols-[minmax(0,1fr)_var(--tru-library-w)] ${
            ...
            >
              ...
              >
                ...
                <div className="tru-scan-library-header mb-3 pb-2 border-b">
                  ...
                  {uploadedPhotos.length === 0 ? (
                    <div className="tru-scan-library-empty tru-scan-library-empty-compact flex flex-col items-center gap-3 py-3">
                      ...
                      >
                        ...
                        <p className="text-sm font-semibold text-foreground">Upload your Images and Videos</p>
