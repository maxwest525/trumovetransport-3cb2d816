    ...
    <SiteShell centered hideTrustStrip>
      ...
      <div className="tru-page-frame">
        ...
        <section className="relative overflow-hidden py-16 md:py-24 lg:py-28">
          ...
          <div className="absolute inset-0 pointer-events-none">
            <img src={heroFamilyMove} alt="" className="absolute inset-0 w-full h-full object-cover opacity-40" />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              {/* LEFT: Headline */}
              <div className="flex flex-col items-center text-center gap-4" ref={heroContentRef}>
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white tracking-tight leading-[1.1] italic">
                  The Smarter Way To <span className="text-primary">Move</span>
                </h1>
                <ul className="space-y-2.5 mt-2 text-white/80 text-sm md:text-base font-light leading-relaxed max-w-xl">
                ...
                {/* Inline trust strip */}
                <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1 mt-4 text-[10px] uppercase tracking-[0.15em] text-white/50 font-medium">
