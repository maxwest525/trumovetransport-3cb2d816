    ...
    <SiteShell hideTrustStrip>
      ...
      <div className="min-h-[80vh] flex flex-col items-center justify-center px-6 py-12">
        <div className="w-full max-w-[1440px] mx-auto">
          ...
          <div className="tru-summary-header-large mb-10" style={{ background: 'transparent', border: 'none', boxShadow: 'none' }}>
            <div className="text-center flex-1">
              <h3 className="text-xl font-black text-foreground">
                Inventory <span className="tru-qb-title-accent">Builder</span>
              </h3>
              <p className="text-[10px] text-muted-foreground uppercase tracking-wide">What are we looking to move?</p>
            </div>
          </div>
