    ...
    <SiteShell hideTrustStrip>
      ...
      <div className="min-h-[80vh] flex flex-col items-center justify-center px-6 py-12">
        <div className="w-full max-w-[1440px] mx-auto">
          ...
          <div className="flex flex-col items-center justify-center text-center mb-8 max-w-xl mx-auto">
            {/* Estimate Mode Toggle */}
            <div className="flex items-center gap-1 rounded-full bg-muted/60 p-1 border border-border/40 shadow-sm">
              <button
                type="button"
                className="flex items-center gap-2 rounded-full px-5 py-2 text-sm font-semibold transition-all bg-primary text-primary-foreground shadow-md"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 rounded-full px-5 py-2 text-sm font-semibold transition-all text-muted-foreground hover:text-foreground hover:bg-muted"
              >
                <Scan className="w-4 h-4" />
                AI Room Scan
                <span className="text-[9px] font-bold px-1.5 py-0.5 rounded-full bg-primary/10 text-primary leading-none">Beta</span>
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr_240px] gap-4 items-start">
            ...
            <div className="relative w-full min-w-0 lg:-mt-6">
