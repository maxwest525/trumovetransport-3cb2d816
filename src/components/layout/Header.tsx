        ...
        <div className="header-inner">
          ...
          <Link to="/site" className="header-logo shrink-0" aria-label="TruMove Home">
            <img 
              src={logo} 
              alt="TruMove" 
              style={{ filter: 'drop-shadow(1px 1px 0 rgba(0,0,0,0.9)) drop-shadow(-1px -1px 0 rgba(0,0,0,0.9)) drop-shadow(1px -1px 0 rgba(0,0,0,0.9)) drop-shadow(-1px 1px 0 rgba(0,0,0,0.9)) drop-shadow(0 4px 6px rgba(0,0,0,0.7)) drop-shadow(0 0 8px rgba(34,197,94,0.9)) drop-shadow(0 0 20px rgba(34,197,94,0.7)) drop-shadow(0 0 40px rgba(34,197,94,0.4))' }}
            />
          </Link>
