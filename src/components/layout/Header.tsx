        ...
        <div className="header-inner">
          ...
          <Link to="/site" className="header-logo shrink-0" aria-label="TruMove Home">
            <img 
              src={logo} 
              alt="TruMove" 
              style={{ filter: 'drop-shadow(0 0 2px rgba(34,197,94,1)) drop-shadow(0 0 8px rgba(34,197,94,0.9)) drop-shadow(0 0 20px rgba(34,197,94,0.7)) drop-shadow(0 0 40px rgba(34,197,94,0.5)) drop-shadow(0 0 80px rgba(34,197,94,0.3)) drop-shadow(0 0 120px rgba(34,197,94,0.15))' }}
            />
          </Link>
